...
/** PortalServer */
#define DEFAULT_PORTALSERVPATH	"/auth/"
#define DEFAULT_PORTALSERVINDEXPATHFRAGMENT "index.html?"
#define DEFAULT_PORTALSERVPORT 80 
/*@}*/
...
typedef struct _portal_serv_t {
    ...
    char *portalserv_index_script_path_fragment;
...
typedef struct {
    ...
    //add by bgofwinter
    t_portal_serv *portal_server; /**< @brief Portal server info */
    //add end
